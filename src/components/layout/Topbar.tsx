  ...
  return (
    <header className="h-20 bg-white/70 dark:bg-[#09090b]/70 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 flex items-center px-8 justify-between sticky top-0 z-10 transition-colors duration-300">
      ...
      <div className="flex items-center gap-5">
        ...
        {/* Global Search Bar - Mac OS Spotlight Style */}
        <div className="hidden md:flex items-center bg-slate-100/80 dark:bg-slate-900/80 rounded-full px-4 py-2 border border-slate-200 dark:border-slate-800 focus-within:border-brand focus-within:ring-2 focus-within:ring-brand/20 transition-all shadow-inner">
          ...
          />
          <kbd className="hidden lg:inline-block ml-2 px-2 py-0.5 text-[10px] font-semibold text-slate-400 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-md">
            ⌘K
          </kbd>
        </div>
        ...
        {/* Action Icons */}
        <button className="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors relative p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800">
          <Bell size={20} />
        ...
        {/* Primary CTA Button */}
        <button className="ml-2 flex items-center gap-2 bg-brand hover:bg-blue-600 text-white px-5 py-2.5 rounded-full font-semibold text-sm transition-all shadow-md shadow-brand/20 active:scale-[0.98]">
          <Plus size={18} />
          <span>New Sale</span>
        </button>
      </div>
