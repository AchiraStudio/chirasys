...
export default function LanSyncSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Host Web Server & QR Code Card */}
      <div className="p-4 rounded-xl bg-gradient-to-r from-primary/10 via-card to-card border border-primary/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xs">
        <div className="flex items-start sm:items-center gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-primary text-white flex items-center justify-center font-bold shrink-0 shadow-sm">
            <QrCode size={20} />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xs font-black text-heading">Akses Kasir Web &amp; Mobile</span>
              <span className="px-2 py-0.5 rounded-full bg-primary-soft text-primary text-[10px] font-black uppercase">
                Siap Pakai
              </span>
            </div>
            <p className="text-[11px] text-dim mt-0.5 max-w-xl">
              Hubungkan smartphone, tablet, atau laptop lain ke komputer ini secara instan tanpa perlu install aplikasi apapun.
            </p>
          </div>
        </div>
        <button
          ...
          className="px-4 py-2.5 bg-primary text-white rounded-xl text-xs font-bold hover:bg-primary/90 transition-all shadow-xs flex items-center justify-center gap-2 shrink-0 cursor-pointer"
        >
          <Smartphone size={15} />
          <span>Buka QR Code Akses</span>
        </button>
      </div>
      ...
      {/* Host Web Server & Mobile Access QR Modal */}
      <HostQrModal
        isOpen={showHostQrModal}
