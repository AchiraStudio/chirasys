// Force HMR reload
// src/pages/reports/LaporanPenjualan.tsx — Daily accumulated sales report
import { useState, useEffect } from 'react';
import { ArrowLeft, Loader2, TrendingUp, ShoppingCart, Tag, DollarSign, ChevronDown, ChevronRight, Trash2, AlertTriangle, FileText, X } from 'lucide-react';
          ...
          <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl p-6 max-w-sm w-full border border-slate-200 dark:border-slate-800 animate-in zoom-in-95">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">Transaksi tidak akan masuk laporan setelah dihapus.</p>
              </div>
            </div>
