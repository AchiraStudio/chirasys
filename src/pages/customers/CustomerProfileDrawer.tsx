...
export default function CustomerProfileDrawer({ isOpen, onClose, customer }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-y-0 right-0 w-full max-w-md bg-white dark:bg-[#0B0F19] shadow-2xl z-50 flex flex-col border-l border-slate-200 dark:border-slate-800 animate-in slide-in-from-right duration-300">
        
        <div className="px-6 py-5 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center glass">
          <div>
